/**
 * Backup copy of app.js — logic identical to app.js except brighter avatar swatches
 * for the sidebar. Default pages still load app.js; swap script src to this file
 * together with /css/style.backup.css if you want the vivid theme preview.
 */
const API = '/api';
...
function renderSidebar(role, activePage) {
  ...
  /* Vivid accent colors (pairs with style.backup.css) */
  const avatarColors = ['#0EA5E9', '#E879F9', '#22C55E', '#FBBF24', '#FB7185'];
