...
public class UIHelper {
    ...
    private static final Border FIELD_BORDER_DEFAULT = BorderFactory.createCompoundBorder(
            BorderFactory.createLineBorder(Theme.GRAY_200),
            BorderFactory.createEmptyBorder(8, 12, 8, 12));
    private static final Border FIELD_BORDER_FOCUS = BorderFactory.createCompoundBorder(
